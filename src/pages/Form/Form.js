...
const Form = () => {
    return (
            ...
            <form id='user-form' className='mt-10 align-center text-center justify-center'>
                                    ...
                                    <div className="lg:col-span-2">
                                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 ">
                                            ...
                                            <div className="md:col-span-5 text-left">
                                                <label for="address" className='text-2xl'>How were you exposed to firefighting foam (AFFF)?</label>
                                                <select placeholder='know about' class="bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 w-80" id="grid-state">
                                            ...
                                            <div className="md:col-span-5 text-left">
                                                <label for="address" className='text-2xl'>Do you already have an attorney representing this case?</label>
                                                <select placeholder='know about' class="bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 w-80" id="grid-state">
                                                    <option><p>--Select--</p></option>
                                                    <option>Yes</option>
                                                    <option>No</option>
